...
fetch("./data.json")
  .then((res) => res.json())
  .then((data) => {
    const summaryList = document.querySelector(".sumary");
    ...
    for (let i = 0; i < data.length; i++) {
      summaryList.innerHTML += `
                <li class="summary__item">
                    ...
                    <span class="summary__score"><span class="summary__score-point">${data[i].score}<span class="summary__score-suffix"> / 100</span>
